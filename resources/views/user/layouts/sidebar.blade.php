...
<div class="main-nav">
    ...
    <div class="logo-box">
         <a href="{{ url('admin.index') }}" class="logo-dark">
              <img src="{{url('assets/admin/assets/images/logo.png')}}" class="logo-sm" alt="logo sm">
              <img src="{{url('assets/admin/assets/images/logo.png')}}" class="logo-lg" alt="logo dark">
         </a>
    ...
    <div class="scrollbar" data-simplebar>
         ...
         <ul class="navbar-nav" id="navbar-nav">
          ...
          @hasanyrole('super-admin|admin')
              ...
              <li class="nav-item">
                   <a class="nav-link menu-arrow" href="#sidebarCalendar" data-bs-toggle="collapse"
                        ...
                        <ul class="nav sub-navbar-nav">
                             ...
                             <li class="sub-nav-item">
                                  <a class="sub-nav-link"
                                       href="apps-calendar-integration.html">Integration</a>
                             </li>
                        </ul>
                   </div>
              </li>
              ...
              <li class="nav-item">
                   ...
                   <div class="collapse" id="sidebarInvoice">
                        <ul class="nav sub-navbar-nav">
                             ...
                             <li class="sub-nav-item">
                                  <a class="sub-nav-link" href="apps-invoice-details.html">Invoice
                                       Details</a>
                             </li>
                        </ul>
                   </div>
              ...
              <li class="nav-item">
                   <a class="nav-link menu-arrow" href="#sidebarExtendedUI" data-bs-toggle="collapse"
                        ...
                        <span class="nav-icon"><iconify-icon
                                  icon="solar:magic-stick-3-broken"></iconify-icon></span>
