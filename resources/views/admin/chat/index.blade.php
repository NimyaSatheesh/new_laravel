                             ...
                             <div class="swiper-wrapper">
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{asset('assets/admin/assets/images/users/avatar-1.jpg')}}" alt="avatar-1" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{ asset('assets/admin/assets/images/users/avatar-2.jpg') }}" alt="avatar-2" class="img-fluid avatar-sm rounded-circle avatar-border" />
                                            </span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{asset('assets/admin/assets/images/users/avatar-3.jpg')}}" alt="avatar-3" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{ asset('assets/admin/assets/images/users/avatar-4.jpg') }}" alt="avatar-4" class="img-fluid avatar-sm rounded-circle avatar-border" />
                                            </span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{asset('assets/admin/assets/images/users/avatar-5.jpg')}}" alt="avatar-5" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{asset('assets/admin/assets/images/users/avatar-6.jpg')}}" alt="avatar-6" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{asset('assets/admin/assets/images/users/avatar-7.jpg')}}" alt="avatar-7" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{asset('assets/admin/assets/images/users/avatar-8.jpg')}}" alt="avatar-8" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{asset('assets/admin/assets/images/users/avatar-9.jpg')}}" alt="avatar-9" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                       </div>
                                  </div>
                                  <div class="swiper-slide avatar-sm">
                                       <div class="chat-user-status-box">
                                            <span><img src="{{asset('assets/admin/assets/images/users/avatar-10.jpg')}}" alt="avatar-10" class="img-fluid avatar-sm rounded-circle avatar-border" /></span>
                                       </div>
                                  </div>
                             </div>
                        </div>
                        ...
                        <div class="tab-content">
                             <div class="tab-pane show active" id="chat-list">
                                  ...
                                  <div class="px-3 mb-3 chat-setting-height" data-simplebar>
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-2.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-2" />
                                                 </div>
                                       ...
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-3.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-3" />
                                                 </div>
                                                 <div class="flex-grow-1 overflow-hidden">
                                                      <h5 class="my-0">
                                       ...
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center bg-light bg-opacity-50 p-2 rounded-1">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-4.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-4" />
                                                 </div>
                                                 <div class="flex-grow-1 overflow-hidden">
                                                      <h5 class="my-0">
                                       ...
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-5.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-5" />
                                                 </div>
                                                 <div class="flex-grow-1 overflow-hidden">
                                                      <h5 class="my-0">
                                       ...
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-6.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-6" />
                                                 </div>
                                                 <div class="flex-grow-1 overflow-hidden">
                                                      <h5 class="my-0">
                                                           <span class="float-end text-muted fs-13">Yesterday</span>
                                       ...
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-7.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-7" />
                                                 </div>
                                                 <div class="flex-grow-1 overflow-hidden">
                                                      <h5 class="my-0">
                                                           <span class="float-end text-muted fs-13">Yesterday</span>
                                       ...
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-8.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-8" />
                                                 </div>
                                                 <div class="flex-grow-1 overflow-hidden">
                                                      <h5 class="my-0">
                                       ...
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-9.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-9" />
                                                 </div>
                                                 <div class="flex-grow-1 overflow-hidden">
                                                      <h5 class="my-0">
                                                           <span class="float-end text-muted fs-13">7/8/21</span>
                                       ...
                                       <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2">
                                                 <div class="flex-shrink-0 position-relative">
                                                      <img src="{{asset('assets/admin/assets/images/users/avatar-10.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-10" />
                                                 </div>
                                                 <div class="flex-grow-1 overflow-hidden">
                                                      <h5 class="my-0">
                                                           <span class="float-end text-muted fs-13">7/8/21</span>
                             ...
                             <div class="tab-pane" id="contact-list">
                                  ...
                                  <div class="px-3 mb-3 chat-setting-height" data-simplebar>
                                       ...
                                       <div class="d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="{{asset('assets/admin/assets/images/users/avatar-2.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
                                            <div class="flex-grow-1">
                                                 <h5 class="my-0 fs-14">Gaston Lapierre</h5>
                                            </div>
                                       </div>
                                       <div class="d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="{{asset('assets/admin/assets/images/users/avatar-3.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
                                            <div class="flex-grow-1">
                                       ...
                                       <div class="d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="{{asset('assets/admin/assets/images/users/avatar-4.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
                                            <div class="flex-grow-1">
                                       ...
                                       <div class="d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="{{asset('assets/admin/assets/images/users/avatar-5.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
                                            <div class="flex-grow-1">
                                       ...
                                       <div class="d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="{{asset('assets/admin/assets/images/users/avatar-6.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
                                            <div class="flex-grow-1">
                                       ...
                                       <div class="d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="{{asset('assets/admin/assets/images/users/avatar-7.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
                                            <div class="flex-grow-1">
                                       ...
                                       <div class="d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="{{asset('assets/admin/assets/images/users/avatar-8.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-2" /></a>
                                            <div class="flex-grow-1">
                        ...
                        <div class="offcanvas offcanvas-start position-absolute shadow w-100" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="user-setting" aria-labelledby="user-settingLabel">
                             ...
                             <div class="offcanvas-body p-0 h-100" data-simplebar>
                                  ...
                                  <div class="d-flex align-items-center px-3 pb-3 border-bottom">
                                       <img src="{{asset('assets/admin/assets/images/users/avatar-1.jpg')}}" class="me-2 rounded-circle" height="36" alt="avatar-1" />
                                       <div class="flex-grow-1">
                                            <div class="float-end">
              ...
              <div class="card position-relative overflow-hidden">
                   ...
                   <div class="card-header d-flex align-items-center mh-100">
                        ...
                        <div class="d-flex align-items-center">
                             <img src="{{asset('assets/admin/assets/images/users/avatar-4.jpg')}}" class="me-2 rounded" height="36" alt="avatar-4" />
                                       ...
                                       <div class="d-flex">
                                            <div class="chat-ctext-wrap">
                                                 <a href="javascript:void(0);">
                                                      <img src="{{asset('assets/admin/assets/images/small/img-1.jpg')}}" alt="attachment" style="height: 84px;" class="img-thumbnail me-1">
                                                 </a>
                                                 <a href="javascript:void(0);">
                                                      <img src="{{asset('assets/admin/assets/images/small/img-2.jpg')}}" alt="attachment" style="height: 84px;" class="img-thumbnail me-1">
                                                 </a>
                                                 <a href="javascript:void(0);">
                                                      <img src="{{asset('assets/admin/assets/images/small/img-3.jpg')}}" alt="attachment" style="height: 84px;" class="img-thumbnail me-1">
                                                 </a>
                                            </div>
                                            <div class="chat-conversation-actions dropdown dropend">
                                                 <a href="javascript: void(0);" class="ps-1" data-bs-toggle="dropdown" aria-expanded="false"><i class='bx bx-dots-vertical-rounded fs-18'></i></a>
                             ...
                             <div class="modal-content video-call">
                                  ...
                                  <div class="modal-header border-0 mb-5 justify-content-end">
                                       <div class="video-call-head">
                                            <img src="{{asset('assets/admin/assets/images/users/avatar-4.jpg')}}" class="rounded" alt="avatar-4" />
                                       </div>
                                  </div>
                             ...
                             <div class="modal-content voice-call">
                                  ...
                                  <div class="modal-header border-0 mt-5 justify-content-center">
                                       <div class="voice-call-head">
                                            <img src="{{asset('assets/admin/assets/images/users/avatar-4.jpg')}}" class="rounded-circle" alt="avatar-4" />
                                       </div>
                                  </div>
                        ...
                        <div class="offcanvas-body p-0 h-100" data-simplebar>
                             <div class="p-3">
                                  <div class="text-center">
                                       <img src="{{asset('assets/admin/assets/images/users/avatar-4.jpg')}}" alt="shreyu" class="img-thumbnail avatar-lg rounded-circle mb-1">
                                  ...
                                  <div class="row gx-1 pt-2">
                                       <div class="col-4">
                                            <a href="javascript:void(0);">
                                                 <img src="{{asset('assets/admin/assets/images/small/img-1.jpg')}}" alt="img-1" class="img-fluid rounded">
                                            </a>
                                       </div>
                                       <div class="col-4">
                                            <a href="javascript:void(0);">
                                                 <img src="{{asset('assets/admin/assets/images/small/img-2.jpg')}}" alt="img-2" class="img-fluid rounded">
                                            </a>
                                       </div>
                                       <div class="col-4">
                                            <div class="position-relative overflow-hidden rounded">
                                                 <a href="javascript:void(0);">
                                                      <img src="{{asset('assets/admin/assets/images/small/img-3.jpg')}}" alt="img-3" class="img-fluid rounded">
