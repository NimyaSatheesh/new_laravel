                            ...
                            <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end"
                                 ...
                                 <div data-simplebar style="max-height: 280px;">
                                      ...
                                      <a href="javascript:void(0);"
                                           ...
                                           <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                     <img src="{{url('assets/admin/assets/images/users/avatar-1.jpg')}}"
                                      ...
                                      <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                           <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                     <img src="{{url('assets/admin/assets/images/users/avatar-3.jpg')}}"
                                                          class="img-fluid me-2 avatar-sm rounded-circle"
                                                          alt="avatar-3" />
                                                </div>
                                                <div class="flex-grow-1">
                                      ...
                                      <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                           <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                     <img src="{{url('assets/admin/assets/images/users/avatar-5.jpg')}}"
                                                          class="img-fluid me-2 avatar-sm rounded-circle"
                                                          alt="avatar-5" />
                                                </div>
                                                <div class="flex-grow-1">
                                ...
                                <a type="button" class="topbar-button" id="page-header-user-dropdown"
                                    ...
                                    <span class="d-flex align-items-center">
                                        <img class="rounded-circle" width="32"
                                            src="{{url('assets/admin/assets/images/users/avatar-1.jpg')}}" alt="avatar-3">
                                    </span>
                                </a>
